package br.com.globalsolution.agrosat.presentation.dto.request.Plantation;
...
public class CreatePlantationRequest {
    ...
    public static Plantation to(CreatePlantationRequest dto) {
        if (dto == null)
            return null;
